...
def slettPerson():
    ...
    slett_person_fra_db(fornavn, etternavn, telefonnummer) # Legger til informasjonen fra input-feltene i databasen som en ny rad

    print("{0} {1} med telefonnummer {2} er blitt slettet."
          .format(fornavn, etternavn, telefonnummer))
    input("Trykk en tast for å gå tilbake til menyen")
    console_clear()
    printMeny()
